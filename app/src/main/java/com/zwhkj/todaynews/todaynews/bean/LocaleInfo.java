...
import com.rtkj.junhetai.chinalife.utils.LocaleUtil;
import com.rtkj.junhetai.chinalife.utils.ObjectUtil;
import com.rtkj.junhetai.chinalife.utils.StringUtil;
...
public final class LocaleInfo
     ...
     */
    public LocaleInfo(Locale locale, String charset, LocaleInfo defaultLocaleInfo) {
        if (locale == null) {
