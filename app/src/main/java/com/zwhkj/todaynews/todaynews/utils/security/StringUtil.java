...
public class StringUtil {
	...
	public static void main(String[] args) throws Exception {
		String s1 = "";

//		System.out.println(getKeyParam(s,15,9));

//		System.out.println(getValueParam(s,15,9));
		String param = setKeyParam(s1, genRandomKeyNum(), 15);
		System.out.println(param);

		System.out.println(getKeyParam(param,15,8));

		System.out.println(getValueParam(param,15,8));
