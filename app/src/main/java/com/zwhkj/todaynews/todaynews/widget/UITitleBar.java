 ...
 * @description 
 * @author JiaBF
 * @date 2015年11月18日 下午2:31:57
 * @update 2015年11月18日
 * @version V1.0
 */
public class UITitleBar extends ViewGroup implements View.OnClickListener {
    private static final int DEFAULT_MAIN_TEXT_SIZE = 24;
    ...
    public void setTitleView(View centerTitleView)
    {
    	mCenterLayout.removeAllViews();
    	mCenterLayout.addView(centerTitleView);
    }
